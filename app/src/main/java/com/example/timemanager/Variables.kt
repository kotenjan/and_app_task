...
object Variables {
    ...
    const val ACTION_SET_TIME = "com.example.app.ACTION_SET_TIME"
    const val ACTION_MODIFY_TIME = "com.example.app.ACTION_MODIFY_TIME"
    const val ACTION_SET_RUNNING_STATE = "com.example.app.ACTION_SET_RUNNING_STATE"
    const val ACTION_NOTIFICATION_FORWARD = "com.example.app.ACTION_NOTIFICATION_FORWARD"
    const val ACTION_NOTIFICATION_BACK = "com.example.app.ACTION_NOTIFICATION_BACK"
    const val ACTION_NOTIFICATION_PLAY = "com.example.app.ACTION_PLAY"
    ...
    const val TIME_LEFT_MODIFIED = "com.example.app.TIME_LEFT_MODIFIED"
    const val START_TIME_MODIFIED = "com.example.app.START_TIME_MODIFIED"
    const val IS_RUNNING_MODIFIED = "com.example.app.IS_RUNNING_MODIFIED"
    const val COLOR_MODIFIED = "com.example.app.COLOR_MODIFIED"
    const val TEXT_MODIFIED = "com.example.app.TEXT_MODIFIED"
